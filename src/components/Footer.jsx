                    ...
                    <div className="bg-white/5 rounded-[2rem] p-6 border border-white/10 relative overflow-hidden group">
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <div className="aspect-square rounded-xl overflow-hidden border border-white/10">
                                <img src="/src/assets/images/s3.jpeg" className="w-full h-full object-cover" alt="Honey" />
                            </div>
                            <div className="aspect-square rounded-xl overflow-hidden border border-white/10">
                                <img src="/src/assets/images/s4.jpeg" className="w-full h-full object-cover" alt="Agri Care" />
                            </div>
                        </div>
